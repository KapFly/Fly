...
更新時間:2023-05-29
酷我音樂vip解鎖
來源:https://github.com/mymoonyue/QuantumultX/tree/master/Scripts/scripts

***************************
QuantumultX:
[rewrite_local]
^https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user) url script-response-body https://raw.githubusercontent.com/KapFly/Fly/main/Script/scripts/coiwantinhei.js
[MITM]
hostname = %APPEND% biz.caiyunapp.com
***************************
Surge4 or Loon:
[Script]
彩雲天氣_SVIP = type=http-response,requires-body=1,max-size=0,pattern=https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user),script-path=https://raw.githubusercontent.com/KapFly/Fly/main/Script/scripts/coiwantinhei.js
...
Shadowrocket:
[Script]
彩雲天氣_SVIP = type=http-response,pattern=https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/kapionhau/Fly/main/Shdowrocket/Script/hukngo.js,script-update-interval=0
